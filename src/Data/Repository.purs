...
-- | a critical, widely-used type in Puregit.
-- |
...
-- | rows & records. I've given a *much* fuller treatment of the topic in the `Puregit.Api.Request`
-- | module. If you stil feel unfamiliar with this pattern, I recommend giving that module a read
-- | before coming back to this one.
module Puregit.Data.Article where

import Prelude

import Puregit.Api.Utils (decodeAt)
import Puregit.Data.PaginatedArray (PaginatedArray)
import Puregit.Data.PreciseDateTime (PreciseDateTime)
import Puregit.Data.Profile (Author, decodeAuthor)
...
-- | invalid states in the type system. It's defined in `Puregit.Data.Profile`.
