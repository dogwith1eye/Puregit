...
-- | the application monad, `Puregit.AppM`.
-- |
...
module Puregit.Capability.LogMessages where

import Prelude

import Puregit.Capability.Now (class Now)
import Puregit.Data.Log (Log, LogReason(..), mkLog)
...
-- | `Log` type from `Puregit.Data.Log`. This type can only be constructed using helper functions
