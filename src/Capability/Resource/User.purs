...
-- | any application code besides the application monad, `Puregit.AppM`. In addition, we can test 
...
module Puregit.Capability.Resource.User where

import Prelude

import Puregit.Api.Request (AuthFieldsRep, LoginFields, RegisterFields)
import Puregit.Data.Profile (Profile, ProfileRep, ProfileWithEmail, Author)
...
-- | `Puregit.Data.Profile` module for more details.
