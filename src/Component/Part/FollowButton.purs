...
module Puregit.Component.Part.FollowButton 
  ( followButton
  , follow
  , unfollow
  ) where
...
import Puregit.Capability.Resource.User (class ManageUser, followUser, unfollowUser)
import Puregit.Component.HTML.Utils (css)
import Puregit.Data.Profile (Author, Relation(..))
