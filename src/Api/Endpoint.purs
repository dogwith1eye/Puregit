...
-- |
-- | This module takes the same approach as the `Puregit.Data.Route` module. For a more in-depth  
...
module Puregit.Api.Endpoint where
...
import Puregit.Data.Route (slug, uname)
