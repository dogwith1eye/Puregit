...
module Puregit.Page.Settings where

import Prelude

import Puregit.Capability.Navigate (class Navigate, logout)
import Puregit.Capability.Resource.User (class ManageUser, getCurrentUser, updateUser)
import Puregit.Component.HTML.Header (header) 
import Puregit.Component.HTML.Utils (css)
import Puregit.Data.Avatar (Avatar)
import Puregit.Data.Avatar as Avatar
import Puregit.Data.Email (Email)
import Puregit.Data.Profile (ProfileWithEmail)
import Puregit.Data.Route (Route(..))
import Puregit.Data.Username (Username)
import Puregit.Data.Username as Username
import Puregit.Form.Field as Field
import Puregit.Form.Validation as V
