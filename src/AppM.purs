...
-- | our capabilities as they are meant to run on our production app. 
-- |
...
-- |
-- | See the various `Puregit.Capability.*` modules for deeper explanations of each capability, and
...
import Puregit.Api.Endpoint (Endpoint(..))
import Puregit.Api.Request (BaseURL, RequestMethod(..))
import Puregit.Api.Request as Request
import Puregit.Api.Utils (authenticate, decode, decodeAt, decodeWithAt, decodeWithUser, mkAuthRequest, mkRequest)
import Puregit.Capability.LogMessages (class LogMessages)
import Puregit.Capability.Navigate (class Navigate, navigate)
import Puregit.Capability.Now (class Now)
import Puregit.Capability.Resource.User (class ManageUser)
import Puregit.Data.Log as Log
import Puregit.Data.Route as Route
import Puregit.Data.Profile (Profile, decodeAuthor, decodeProfileWithEmail)

-- | In the capability modules (`Puregit.Capability.*`), we wrote some abstract, high-level 
